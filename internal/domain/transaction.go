...
type Transaction struct {
	...
	UserID              string         `gorm:"type:uuid;not null;index:idx_transaction_user_date" json:"user_id"`
	...
	TransactionDate     time.Time      `gorm:"not null;index:idx_transaction_user_date" json:"transaction_date"`
